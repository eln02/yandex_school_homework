...
class $AssetsGifsGen {
  ...
  /// File path: assets/gifs/money_cat.gif
  AssetGenImage get moneyCat =>
      const AssetGenImage('assets/gifs/money_cat.gif');

  /// List of all assets
  List<AssetGenImage> get values => [moneyCat];
}

class $AssetsIconsGen {
  const $AssetsIconsGen();

  /// File path: assets/icons/accounts.svg
  SvgGenImage get accounts => const SvgGenImage('assets/icons/accounts.svg');
  ...
  /// List of all assets
  List<SvgGenImage> get values => [accounts, expenses, income, items, settings];
}
