...
// in yandex_school_homework/test/secure_auth_service_test.dart.
...
/// A class which mocks [IDebugService].
///
/// See the documentation for Mockito's code generation for more information.
class MockIDebugService extends _i1.Mock implements _i5.IDebugService {
  @override
  void log(Object? message, {Object? logLevel, Map<String, dynamic>? args}) =>
      super.noSuchMethod(
        Invocation.method(#log, [message], {#logLevel: logLevel, #args: args}),
        returnValueForMissingStub: null,
      );
  ...
  void logDebug(
    ...
    Invocation.method(#logDebug, [message], {#logLevel: logLevel, #args: args}),
    returnValueForMissingStub: null,
  );

  @override
  _i4.Future<T?> openDebugScreen<T>(
